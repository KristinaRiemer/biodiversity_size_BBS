# Code from: Among-species overlap in rodent body size distributions predicts species richness along a temperature gradient. Read, Quentin, Grady, John, Zarnetske, Phoebe, Record, Sydne, Baiser, Benjamin, Belmaker, Jonathan, Tuanmu, Mao-Ning, Strecker, Angela, Beaudrot, Lydia, Thibault, Katherine. Ecography.

# Code for archiving with Ecography manuscript
# 24 July 2017 QDR
